...
public class TournamentsWindowView {
	...
	public TournamentsWindowView(MenuWindowController menuWindowController) {
	...
	private JPanel initializeGamesButtonPanel() {
		...
		gamesButton = new JButton("Партии");
